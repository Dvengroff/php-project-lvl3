        ...
        <div class='container'>
            <div class='row'>
                <div class='col-lg-7 col-md-9 col-sm-12 text-white'>
                    <h1>SeoAnalyzer</h1>
                    <p class='text-white-50'>Простой и быстрый сервис по анализу веб-страниц на SEO пригодность</p>
                    <hr class="my-4 mx-md-5 bg-secondary">
                    <form action="{{route('domains.store')}}" method="post" class="mx-md-5">
                        <div class="form-group">
                            <label for="page-url-input">Введите URL веб-страницы, которую хотите проанализировать:</label>
